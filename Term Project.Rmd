...
yelp9 <- "https://api.yelp.com/v3/businesses/search/?limit=50&offset=400&sort=0&term=food&location=MI"
yelp10 <- "https://api.yelp.com/v3/businesses/search/?limit=50&offset=450&sort=0&term=food&location=MI"
yelp11 <- "https://api.yelp.com/v3/businesses/search/?limit=50&offset=500&sort=0&term=food&location=MI"
yelp12 <- "https://api.yelp.com/v3/businesses/search/?limit=50&offset=550&sort=0&term=food&location=MI"
...
restaurant_data9 <- do.call("rbind", results_list9)
restaurant_data10 <- do.call("rbind", results_list10)
restaurant_data11 <- do.call("rbind", results_list11)
restaurant_data12 <- do.call("rbind", results_list12)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;One of the columns of interest in our dataset (all_restaurant), 'categories', requires some clean-up with formatting. Thus, we will reformat that column in order to make it more understandable and clear.
