...
```{r, warning = FALSE}
obesity <- read_csv("https://raw.githubusercontent.com/daraeoh/survmeth727/master/Obesity%20Michigan%20County%20Level%20Data.csv")
```
...
```{r}
master <-inner_join(all_establishments, obesity, by = "county")
```
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Christoph: The results section may have a data exploration part, but in general the structure here depends on the specific project.
