...
model1 <- lm(obesity_avg ~ factor(categories), data = master)
summary(model1)
```

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The R-squared value of our preliminary model was quite low (0.048), indicating poor model fit. To improve upon the model, we added county to the same model as above.
