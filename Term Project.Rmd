...
```{r}
#code that removes the three bad categories. too lazy to write the code now so i'm just 
#creating a comment lol.
```

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;After removing the "Non-restaurant", "Grocery", and "Other" categories from all_establishments, our final dataset of cuisines and counties includes __ observations.
