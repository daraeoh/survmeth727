...
str_replace_all(., "", "") %>%&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Our cleaned data has 1570 observations since the most populated area of certain counties have less than 20 food establishment options on Yelp.

str_replace_all(., "", "") %>%_Obesity Data_
